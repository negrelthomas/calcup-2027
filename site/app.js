...
(function () {
  ...
  function renderConcession(el){
    ...
    var gearSec='<section><div class="sec-head"><h2>Commemorative gear</h2><span class="note">pre-order only &middot; XXth edition</span></div>'+gearMsg+'<div class="grid cols-3">'+
      ...
      gcard("calcup-hat.jpg","Commemorative hat","XXth-edition flat-visor snapback","$40")+
      '</div></section>';
    ...
    var dealsSec='<section><div class="sec-head"><h2>Bundles &amp; deals</h2><span class="note">grab them at the concession stand</span></div><div class="grid cols-3 deal-grid">'+
      ...
      dealCard({theme:'',save:'$15',title:'Hat &amp; shirt bundle',desc:'CalCup cap + CalCup tee',price:'$45',value:'$60 value',cta:'Concession stand',cicon:'ti-shopping-bag',vis:'<img class="deal-img" src="assets/merch/hat-shirt-bundle.jpg" alt="CalCup cap and tee" onerror="this.style.display=\'none\'">'})+
